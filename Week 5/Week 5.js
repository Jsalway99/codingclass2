...
var score = 0;
function preload() {
    idleStrings = loadStrings("");
    walkStrings = loadStrings("");
}
...
function setup() {
    ...
    objectToEat = new myImage("", 500, 200, 100, 100);
    myFont = loadFont("");
...
{
    console.log("HI");
    objectToEat = new myImage("../image/Paimon dimb.png", random(50, width-100), random(50,height-100), 100, 100);
}
